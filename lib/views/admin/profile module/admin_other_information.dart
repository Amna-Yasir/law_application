...
class adminBasicInfo extends StatefulWidget {
  const adminBasicInfo({super.key});

  @override
  State<adminBasicInfo> createState() => _clientBasicInfo();
}

class _clientBasicInfo extends State<adminBasicInfo> {
