...
import 'package:law_application/views/admin/admin%20signup/signup_controller.dart';
...
class admin_signUpScreen extends StatefulWidget {
  const admin_signUpScreen({super.key});

  @override
  State<admin_signUpScreen> createState() => _admin_signUpScreenState();
}

class _admin_signUpScreenState extends State<admin_signUpScreen> {
      ...
      body: SafeArea(
        child: Padding(
            ...
            child: ChangeNotifierProvider(
              create: (_) => admin_signupController(),
              child: Consumer<admin_signupController>(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Inputextfield(
                                        ...
                                        obsecuretext: true),
                                    Inputextfield(
                                        mycontoller: employeeidcontroller,
                                        focusnode: emailfocusnode,
                                        onFilledSubmittedvalue: (value) {
                                          utils.fieldfocus(
                                              context,
                                        ...
                                        onValidator: (value) {
                                          ...
                                          int? employeeId = int.tryParse(value);
                                          if (employeeId == null) {
