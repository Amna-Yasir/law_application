...
class admin_signupController with ChangeNotifier {
  ...
  void signUp(BuildContext context, String username, String emailaddress,
    ...
    try {
      auth
        ...
        ref.child(value.user!.uid.toString()).set({
          ...
          Navigator.pushNamed(context, RouteName.adminbasicInfo);
